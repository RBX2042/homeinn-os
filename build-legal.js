...
const PAGES = [
  ...
  },
  {
    ...
    secties: [
      ...
      ['Deelname in een ontwikkelproject', 'Op deelname in een ontwikkelproject zijn uitsluitend de bepalingen van de betreffende onderhandse overeenkomst van toepassing. Deelname is beleggen: het rendement is niet gegarandeerd en de inleg kan geheel of gedeeltelijk verloren gaan. Deelname staat uitsluitend open voor professionele marktpartijen: vanaf € 100.000 ineens per deelnemer. Informatie op deze website en in projectdocumentatie is een uitnodiging tot gesprek en geen aanbod; wijkt de onderhandse overeenkomst af van deze voorwaarden, dan gaat die overeenkomst voor.'],
      ['Totstandkoming en duur', 'Een overeenkomst komt tot stand zodra de opdrachtbevestiging schriftelijk of per e-mail door beide partijen is aanvaard. Beheerovereenkomsten worden aangegaan voor onbepaalde tijd, tenzij anders overeengekomen. Opgegeven <strong>uitvoerings</strong>termijnen — verbouwing, oplevering, onboarding van beheer — zijn indicatief en nooit fataal, tenzij uitdrukkelijk anders is vastgelegd. Dit geldt uitdrukkelijk <strong>niet</strong> voor de reactie- en voorsteltermijnen die wij op onze website noemen: dat u binnen vier uur op werkdagen een reactie krijgt en binnen 48 uur na de opname een onderbouwd voorstel, zeggen wij toe. Halen wij dat niet, laat het ons dan weten.'],
...
<head>
  <meta charset="utf-8">
  <script>try{var t=localStorage.getItem('hi-theme');if(t==='dark'||t==='light')document.documentElement.setAttribute('data-theme',t)}catch(e){}</script>
  ...
  <link rel="stylesheet" href="fonts/fonts.css?v=20260920bd">
  <link rel="stylesheet" href="tokens.css?v=20260920bd">
  <link rel="stylesheet" href="homeinn-public.css?v=20260920bd">
  <style>
    ...
    .legal-doc p,.legal-doc li{max-width:72ch}.lg-toc{margin:0 0 2.5rem;padding:1.25rem 1.5rem;background:var(--cream2);border-left:3px solid var(--gold)}.lg-toc span{display:block;font-size:.72rem;letter-spacing:.14em;text-transform:uppercase;color:var(--ink3);margin-bottom:.6rem}.lg-toc ol{margin:0;padding-left:1.2rem;columns:2;column-gap:2rem;font-size:.9rem;line-height:1.9}.lg-toc a{color:var(--navy-text);text-decoration:none;border-bottom:1px solid rgba(var(--gold-rgb),.35)}@media(max-width:720px){.lg-toc ol{columns:1}}.legal-doc h2{scroll-margin-top:90px}.lg-other{max-width:760px;margin:0 auto;padding:0 clamp(1.5rem,5vw,2rem) clamp(3rem,6vw,5rem);display:flex;flex-wrap:wrap;gap:1.25rem;font-size:.82rem}
...
<body>
  ...
  <script src="site-nav.js?v=20260920bd"></script>
</body>
</html>
`;
}
